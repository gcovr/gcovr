...
gcovr.fileLoaded = function () {
  ...
  gcovr.addOnClickHandler(".button_toggle_REMOVED", gcovr.toggleLines);
  gcovr.addOnClickHandler(".button_toggle_ADDED", gcovr.toggleLines);
  gcovr.addOnClickHandler(".button_toggle_CHANGED", gcovr.toggleLines);
  gcovr.addOnClickHandler(".button_toggle_APPROXIMATELY_EQUAL", gcovr.toggleLines);
  gcovr.addOnClickHandler(".button_toggle_STRICTLY_EQUAL", gcovr.toggleLines);
