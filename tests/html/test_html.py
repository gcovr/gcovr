...
def test_less_lines(
    ...
    """Test HTML single page output variants."""
    if gcovr_test_exec.is_gcc() and gcovr_test_exec.cc_version() >= 8:
        gcovr_test_exec.skip("GCC >= 8 stubs the missing lines.")
    if gcovr_test_exec.is_llvm() and gcovr_test_exec.cc_version() >= 13:
        gcovr_test_exec.skip("Clang >= 13 stubs the missing lines.")
